...
import io.revealbi.samples.browser.shiro.BearerProviderToken;
...
public class LoginResource {	
	...
	public LoginResponse login(LoginRequest request) throws IOException {
		...
		if (request.accessToken == null && request.password.trim().length() == 0) {
			return new LoginResponse(false, null, "Password required");
		}
