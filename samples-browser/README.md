# Backend application for [RevealBI](https://revealbi.io/) Samples Browser
...
Now you can deploy the file `target/samples.war` to your Tomcat server, this application has been tested using Tomcat 9.

Assuming Tomcat is using the standard port, you can access the application at http://localhost:8080/samples.
